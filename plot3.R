...
plot(plot3_df$date_time,plot3_df$sub_metering_1,type="l",ylim=c(0,40),ylab="Energy sub metering",xlab="")
par(new="TRUE")
plot(plot3_df$date_time,plot3_df$sub_metering_2,type="l",ylim=c(0,40),xlab="",ylab="",col="red")
par(new="TRUE")
plot(plot3_df$date_time,plot3_df$sub_metering_3,type="l",ylim=c(0,40),xlab="",ylab="",col="blue")
